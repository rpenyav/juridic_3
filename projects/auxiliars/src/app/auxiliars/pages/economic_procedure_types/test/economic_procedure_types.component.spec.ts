...
describe('EconomicProceduretypesComponent', () => {
  ...
  let fixture: ComponentFixture<EconomicProceduretypesComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [TestingModule],
      declarations: [EconomicProceduretypesComponent],
      schemas: [CUSTOM_ELEMENTS_SCHEMA],
    }).compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(EconomicProceduretypesComponent);
