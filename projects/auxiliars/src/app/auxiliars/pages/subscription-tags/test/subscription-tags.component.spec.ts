...
import { AdresstypesComponent } from '../adresstypes.component';
import { of } from 'rxjs';
import { AddressType } from 'src/app/interfaces/address-type';

describe('AdresstypesComponent', () => {
  let component: AdresstypesComponent;
  let fixture: ComponentFixture<AdresstypesComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [TestingModule],
      declarations: [AdresstypesComponent],
      schemas: [CUSTOM_ELEMENTS_SCHEMA],
    }).compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(AdresstypesComponent);
