...
import { LegalRepresentations, PaginatedResponse } from 'src/app/interfaces/personal/legal-representations';
  ...
  delete(addressTypes: LegalRepresentations) {
    ...
    showCustomAlert(this.txt, {
      ...
      if (result.isConfirmed) {
        this.generalService
          .deleteRegisterType<LegalRepresentations>(this.ENDPOINT, addressTypes.id!)
          .subscribe({
            next: (response) => {
