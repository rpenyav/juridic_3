...
import { ReturnReasons } from 'src/app/interfaces/return_reasons';

import { GeneralService } from 'src/app/services/general.service';
import Swal from 'sweetalert2';

@Component({
  selector: 'app-return-reasons-detail',
  templateUrl: './return-reasons-detail.component.html',
  styleUrls: ['./return-reasons.component.scss'],
})
export class ReturnReasonsDetailComponent implements OnInit {
  ...
  submitNewRecord(insertData: any, language: number): void {
    ...
    this.generalService
      .createRegisterType<ReturnReasons>(customEndpoint, dataToSend as ReturnReasons)
      .subscribe({
        next: () => {
          Swal.fire({
            icon: 'success',
