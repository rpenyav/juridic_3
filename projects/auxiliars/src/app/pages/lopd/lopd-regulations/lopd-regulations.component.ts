...
import { LopdRegulations, PaginatedResponse } from 'src/app/interfaces/lopd/lopd-regulations';

@Component({
  selector: 'app-lopd-regulations',
  templateUrl: './lopd-regulations.component.html',
  styleUrls: ['./lopd-regulations.component.scss'],
})
export class LopdRegulationsComponent implements OnInit {
  ...
  detailUrl: string = 'lopd-regulations';
  ...
  addressTypesData: LopdRegulations[] = [];
  filteredRegistersData: LopdRegulations[] = [];
  ...
  updateTableData(data: LopdRegulations[]): void {
  ...
  create(addressTypesData: LopdRegulations) {
    console.log('Enviando datos al servidor:', addressTypesData);
    this.generalService
      .createRegisterType<LopdRegulations>(this.ENDPOINT, addressTypesData)
      .subscribe({
        next: (response) => {
   ...
   * @param addressTypes
   */
  delete(addressTypes: LopdRegulations) {
    ...
    showCustomAlert(this.txt, {
      ...
      if (result.isConfirmed) {
        this.generalService
          .deleteRegisterType<LopdRegulations>(this.ENDPOINT, addressTypes.id!)
          .subscribe({
            next: (response) => {
