...
import {
  PaginatedResponse,
  EconomicProcedureType,
} from 'src/app/interfaces/economic_procedure_types';
...
@Component({
  selector: 'app-economic-procedure-types',
  templateUrl: './economic_procedure_types.component.html',
  styleUrls: ['./economic_procedure_types.component.scss'],
})
export class EconomicProceduretypesComponent implements OnInit {
  assetsBaseUrl = environment.assetsBaseUrl;
  endpoints = getApiEndpoints();
  ENDPOINT = `${this.endpoints.PRO_ECO}`;
  addressTypesData: EconomicProcedureType[] = [];
  filteredRegistersData: EconomicProcedureType[] = [];
  ...
  detailUrl: string = 'economics-procedure-type';
  ...
  updateTableData(data: EconomicProcedureType[]): void {
  ...
  create(addressTypesData: EconomicProcedureType) {
    console.log('Enviando datos al servidor:', addressTypesData);
    this.generalService
      .createRegisterType<EconomicProcedureType>(
        this.ENDPOINT,
        addressTypesData
      )
      .subscribe({
   ...
   * @param addressTypes
   */
  delete(addressTypes: EconomicProcedureType) {
    ...
    showCustomAlert(this.txt, {
      ...
      if (result.isConfirmed) {
        this.generalService
          .deleteRegisterType<EconomicProcedureType>(
            this.ENDPOINT,
            addressTypes.id!
          )
          .subscribe({
