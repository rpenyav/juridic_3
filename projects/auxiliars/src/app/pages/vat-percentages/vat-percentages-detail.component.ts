...
import { VatPercentages } from 'src/app/interfaces/vat-percentages';
import { GeneralService } from 'src/app/services/general.service';
import Swal from 'sweetalert2';

@Component({
  selector: 'app-vat-percentages-detail',
  templateUrl: './vat-percentages-detail.component.html',
...
export class VatPercentagesDetailComponent implements OnInit {
  ...
  id: string | null = null;
  registerDetail: VatPercentages | null = null;
  originalData: VatPercentages | null = null;
  ...
  redirectRoute: string = 'vat-percentages'; //ruta retorn al llistat
  titolKey = 'VAT_PERCENTAGES.TITLE';
