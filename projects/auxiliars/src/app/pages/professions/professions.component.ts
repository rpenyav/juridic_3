...
import { Professions, PaginatedResponse } from 'src/app/interfaces/personal/professions';
...
export class ProfessionsComponent implements OnInit {
  ...
  addressTypesData: Professions[] = [];
  filteredRegistersData: Professions[] = [];
  ...
  updateTableData(data: Professions[]): void {
  ...
  create(addressTypesData: Professions) {
    console.log('Enviando datos al servidor:', addressTypesData);
    this.generalService
      .createRegisterType<Professions>(this.ENDPOINT, addressTypesData)
      .subscribe({
        next: (response) => {
   ...
   * @param addressTypes
   */
  delete(addressTypes: Professions) {
    ...
    showCustomAlert(this.txt, {
      ...
      if (result.isConfirmed) {
        this.generalService
          .deleteRegisterType<Professions>(this.ENDPOINT, addressTypes.id!)
          .subscribe({
            next: (response) => {
