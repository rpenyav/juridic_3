...
import { PaginatedResponse, Countries } from 'src/app/interfaces/countries';
...
export class CountriesComponent implements OnInit {
  ...
  filteredRegistersData: Countries[] = [];
  ...
  updateTableData(data: Countries[]): void {
  ...
  formConfig = [
    { key: 'literalNameText', label: 'Nom', validators: [] },
  ...
  create(registerTypesData: Countries) {
    console.log('Enviando datos al servidor:', registerTypesData);
    this.generalService
      .createRegisterType<Countries>(this.ENDPOINT, registerTypesData)
      .subscribe({
        next: (response) => {
  ...
  delete(nametype: Countries) {
    ...
    showCustomAlert(this.txt, {
      ...
      if (result.isConfirmed) {
        this.generalService
          .deleteRegisterType<Countries>(this.ENDPOINT, nametype.id!)
          .subscribe({
            next: (response) => {
