...
import { SubscriptionStatus, PaginatedResponse } from 'src/app/interfaces/subscriptions/subscription-status';
  ...
  delete(addressTypes: SubscriptionStatus) {
    ...
    showCustomAlert(this.txt, {
      ...
      if (result.isConfirmed) {
        this.generalService
          .deleteRegisterType<SubscriptionStatus>(this.ENDPOINT, addressTypes.id!)
          .subscribe({
            next: (response) => {
