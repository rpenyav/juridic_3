...
import {
  SubscriptionParentals,
  PaginatedResponse,
} from 'src/app/interfaces/subscriptions/subscription-parentals';

@Component({
  selector: 'app-durations-parentals',
  templateUrl: './subscription-parentals.component.html',
  styleUrls: ['./subscription-parentals.component.scss'],
})
export class SubscriptionParentalsComponent implements OnInit {
  ...
  detailUrl: string = 'subscription-parentals';
  ...
  addressTypesData: SubscriptionParentals[] = [];
  filteredRegistersData: SubscriptionParentals[] = [];
  ...
  updateTableData(data: SubscriptionParentals[]): void {
  ...
  create(addressTypesData: SubscriptionParentals) {
   ...
   * @param addressTypes
   */
  delete(addressTypes: SubscriptionParentals) {
    ...
    showCustomAlert(this.txt, {
      ...
      if (result.isConfirmed) {
        this.generalService
          .deleteRegisterType<SubscriptionParentals>(
            this.ENDPOINT,
            addressTypes.id!
          )
          .subscribe({
