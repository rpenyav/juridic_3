...
import { SubscriptionProcedures } from 'src/app/interfaces/subscriptions/subscription-prodedures';
...
export class SubscriptionProceduresDetailComponent implements OnInit {
  ...
  submitNewRecord(insertData: any, language: number): void {
    ...
    this.generalService
      .createRegisterType<SubscriptionProcedures>(customEndpoint, dataToSend as SubscriptionProcedures)
      .subscribe({
        next: () => {
          Swal.fire({
            icon: 'success',
