...
} from 'src/app/interfaces/company_relation_types';
...
@Component({
  ...
  templateUrl: './company_relation_types.component.html',
...
export class CompanyRelationTypesComponent implements OnInit {
  ...
  filteredRegistersData: CompanyRelationTypes[] = [];
  ...
  detailUrl: string = 'company_relation_types';
  ...
  updateTableData(data: CompanyRelationTypes[]): void {
  ...
  create(addressTypesData: CompanyRelationTypes) {
    console.log('Enviando datos al servidor:', addressTypesData);
    this.generalService
      .createRegisterType<CompanyRelationTypes>(this.ENDPOINT, addressTypesData)
      .subscribe({
        next: (response) => {
  ...
  delete(addressTypes: CompanyRelationTypes) {
    ...
    showCustomAlert(this.txt, {
      ...
      if (result.isConfirmed) {
        this.generalService
          .deleteRegisterType<CompanyRelationTypes>(
            this.ENDPOINT,
            addressTypes.id!
          )
          .subscribe({
